...
Public Class PBarVertical
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim lb As New LinearGradientBrush(New Rectangle(0, 0, Me.Height, Me.Width), Color.FromArgb(255, Me.GradColor1), Color.FromArgb(55, Me.GradColor2), gradien)
        Dim width As Integer = CInt(percent / ValueMax * Me.Width)
        Dim height As Integer = CInt(percent / ValueMax * Me.Height)
        e.Graphics.FillRectangle(b, 0, 0, height, Me.Width)
        e.Graphics.FillRectangle(lb, 0, 0, height, Me.Width)
        'b.Dispose() : lb.Dispose()
        lb.Dispose() : b.Dispose()
    End Sub
    Private Sub ProBar_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        LabelPB.Location = New Point(Me.Width / 2 - LabelPB.Width / 2, Me.Height / 2 - LabelPB.Height / 2)
